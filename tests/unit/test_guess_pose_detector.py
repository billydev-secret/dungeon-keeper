"""Tier 1 unit tests: guess pose detector pure geometry helpers.

No images, no mediapipe. Only guess_models + guess_pose_detector imports.
"""
from __future__ import annotations

import pytest

from bot_modules.services.guess_pose_detector import (
    _Lm,
