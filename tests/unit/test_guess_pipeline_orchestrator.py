"""Tier 2 unit tests: guess pipeline orchestrator (run_pipeline + run_reroll).
...
class TestRunPipeline:
    """Tests for services.guess_pipeline.run_pipeline."""
    ...
    def _run(
        ...
        *,
        ...
        with patch.dict(
            ...
            {
                "PIL": mock_pil,
                "bot_modules.services.guess_nudenet": mock_nudenet,
                "bot_modules.services.guess_face_detector": mock_face_det,
                "bot_modules.services.guess_pose_detector": mock_pose_det,
                "bot_modules.services.guess_crop_renderer": mock_crop_ren,
            },
        ):
            from bot_modules.services.guess_pipeline import run_pipeline  # noqa: PLC0415
    ...
    def test_no_detections_returns_empty_result(self):
        ...
        # a random crop of an arbitrary image to the Guess channel.
...
class TestRunReroll:
    """Tests for services.guess_pipeline.run_reroll."""
    ...
    def _run(
        ...
        *,
        ...
        with patch.dict(
            ...
            from bot_modules.services.guess_pipeline import run_reroll  # noqa: PLC0415
