"""Unit tests for services/guess_face_detector.py — mocked mediapipe/PIL/numpy."""
...
def test_detect_faces_one_face_returns_one_bounding_box():
    ...
    with patch.dict("sys.modules", patches), \
         patch("bot_modules.services.guess_face_detector._ensure_face_model", return_value=Path("/fake/model.tflite")):
