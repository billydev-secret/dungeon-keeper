...
def test_guide_embed_defaults_cover_earning_and_spending():
    ...
    # what-pays-what rows are aligned: label cell (padded to the widest
    # label, so don't pin the exact width), payment outside
    assert re.search(r"`First message of the day *` 🪙 5\b", earning)
