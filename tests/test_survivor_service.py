...
@pytest.mark.parametrize(
    ...
    [
        ...
        # The Tier 2 rules still unbuilt (double-pick escalation, the Accord)
        # have no dials — storing one would be a silent no-op an admin can't
        # tell from an enforced rule. wipeout_annul_through_week left this
        # list on 2026-09-11, when the rule that reads it shipped.
