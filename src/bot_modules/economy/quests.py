...
TRIGGER_FLAVOR: dict[str, str] = {
    ...
    "auction_bid": "going once, going twice",
...
TRIGGER_KIND_INFO: dict[str, str] = {
    ...
    "auction_bid": "Placing a bid that actually lands in an auction — keyed to the bid row, so a bid rejected as too low or lost to a race never counts. The stake is escrowed and comes back if you are outbid; the quest asks for the bid, not the win. Event cadence: once per bid.",
