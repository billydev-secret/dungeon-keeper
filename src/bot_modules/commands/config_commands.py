...
def _build_booster_overview(
    ...
    from bot_modules.services.booster_roles import get_booster_roles, get_swatch_directory
...
class _AddBoosterRoleModal(discord.ui.Modal, title="Add Booster Role"):
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        from bot_modules.services.booster_roles import get_booster_roles, upsert_booster_role
...
class _EditBoosterRoleModal(discord.ui.Modal, title="Edit Booster Role"):
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        from bot_modules.services.booster_roles import upsert_booster_role
...
if TYPE_CHECKING:
    from bot_modules.services.booster_roles import BoosterRoleRow
...
class _BoosterRoleDetailView(discord.ui.View):
    ...
    async def _on_remove(self, interaction: discord.Interaction) -> None:
        if interaction.user.id != self._invoker_id:
            await interaction.response.defer()
            return
        from bot_modules.services.booster_roles import delete_booster_role
...
class _SwatchPathModal(discord.ui.Modal, title="Set Swatch Directory"):
    def __init__(
        ...
        from bot_modules.services.booster_roles import get_swatch_directory
...
class _BoosterConfigView(discord.ui.View):
    ...
    async def _on_sync(self, interaction: discord.Interaction) -> None:
        if interaction.user.id != self._invoker_id:
            await interaction.response.defer()
            return
        from bot_modules.services.booster_roles import sync_swatches
    ...
    async def _on_post(self, interaction: discord.Interaction) -> None:
        if interaction.user.id != self._invoker_id:
            await interaction.response.defer()
            return
        from bot_modules.services.booster_roles import post_or_update_booster_panel
