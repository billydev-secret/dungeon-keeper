"""Gender classification commands."""
...
from bot_modules.services.gender_service import (
    VALID_GENDERS,
    get_gender,
...
class GenderCog(commands.Cog):
    ...
    @gender.command(name="set", description="Set or change a member's gender tag.")
    ...
    @gender.command(name="check", description="See a member's current gender tag.")
    @app_commands.describe(member="Member to check.")
    async def gender_check(
    ...
    async def gender_classify(self, interaction: discord.Interaction) -> None:
        ctx = self.ctx
...
async def setup(bot: Bot) -> None:
    await bot.add_cog(GenderCog(bot, bot.ctx))
