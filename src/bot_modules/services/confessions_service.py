...
# Saturation floor below which a bucket is treated as gray when picking the
# avatar highlight colour (see ``dominant_highlight_color``).
_MIN_VIVID_SAT = 0.20
...
def dominant_highlight_color(image_bytes: bytes) -> Optional["discord.Colour"]:
    """Extract a vivid "highlight" colour from an avatar image.
