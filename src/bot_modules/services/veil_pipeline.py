...
def run_pipeline(
    ...
    *,
    ...
    from bot_modules.services.veil_nudenet import detect as nudenet_detect  # noqa: PLC0415
    from bot_modules.services.veil_face_detector import detect_faces  # noqa: PLC0415
    from bot_modules.services.veil_pose_detector import detect_pose  # noqa: PLC0415
