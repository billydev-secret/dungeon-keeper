...
from bot_modules.core.post_monitoring import message_has_qualifying_image
from bot_modules.core.utils import format_user_for_log, get_guild_channel_or_thread, resolve_reply_target
...
if TYPE_CHECKING:
    ...
    from bot_modules.core.xp_system import PairState
