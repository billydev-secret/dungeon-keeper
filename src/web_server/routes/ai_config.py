...
async def update_command_model(
    ...
    def _q():
        from bot_modules.services.ai_config import get_prompt_info, set_command_model
...
async def update_prompt(
    ...
    def _q():
        from bot_modules.services.ai_config import get_prompt_info, set_prompt
...
async def reset_prompt(
    ...
    def _q():
        from bot_modules.services.ai_config import get_prompt_info
        from bot_modules.services.ai_config import reset_prompt as _reset
