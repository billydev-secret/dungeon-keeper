  ...
  mountGamePanel(container, {
    ...
    optSchema: [
      { key: "min_players", label: "Minimum Players", type: "number", default: 3, min: 2, max: 25,
        hint: "A round won't start until this many people have joined (2–25)." },
      { key: "max_players", label: "Maximum Players", type: "number", default: 25, min: 0, max: 25,
        hint: "Latecomers are turned away once the lobby is this full. Up to 25 — the vote menu holds 25 names — and 0 means the full 25." },
