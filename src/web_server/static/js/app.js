...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "config-bios",           label: "Bios — Config",    module: "./panels/config-bios.js" },
      { id: "config-bios-fields",    label: "Bios — Fields",    module: "./panels/config-bios-fields.js" },
      { id: "config-bios-questions", label: "Bios — Questions", module: "./panels/config-bios-questions.js" },
