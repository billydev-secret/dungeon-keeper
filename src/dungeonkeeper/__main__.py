...
from bot_modules.services.anon_audit_service import anon_audit_purge_loop
...
def main() -> None:
    ...
    bot.extension_names = [
        ...
        "bot_modules.cogs.retention_cog",
        "bot_modules.cogs.guild_purge_cog",
    ...
    bot.startup_task_factories.append(lambda: event_echo_loop(bot))
    ...
    bot.startup_task_factories.append(lambda: anon_audit_purge_loop(bot, db_path))
