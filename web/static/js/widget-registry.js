...
const WIDGETS = [
  // ── Home tiles ───────────────────────────────────────────────────
  { id: "home-messages",    label: "Messages (24h)",          category: "Home", perms: [], source: "home", wide: false },
  { id: "home-nsfw",        label: "NSFW (24h)",              category: "Home", perms: [], source: "home", wide: false },
  { id: "home-presence",    label: "Presence",                category: "Home", perms: [], source: "home", wide: false },
  { id: "home-xp",          label: "XP Today",                category: "Home", perms: [], source: "home", wide: false },
  { id: "home-joins",       label: "Recent Joins",            category: "Home", perms: [], source: "home", wide: false },
  { id: "home-moderation",  label: "Moderation",              category: "Home", perms: [], source: "home", wide: false },
  { id: "home-voice",       label: "In Voice Now",            category: "Home", perms: [], source: "home", wide: false },
  { id: "home-channels",    label: "Hottest Channels (1h)",   category: "Home", perms: [], source: "home", wide: false },
  { id: "home-users",       label: "Most Active Users (1h)",  category: "Home", perms: [], source: "home", wide: false },
  { id: "home-returned",    label: "Returned After Break",    category: "Home", perms: [], source: "home", wide: false },
  { id: "home-starters",    label: "Conversation Starters",   category: "Home", perms: [], source: "home", wide: false },
  { id: "home-butterflies", label: "Social Butterflies",      category: "Home", perms: [], source: "home", wide: false },
  { id: "home-loyalists",   label: "Channel Loyalists",       category: "Home", perms: [], source: "home", wide: false },
  { id: "home-mod-actions", label: "Recent Mod Actions",      category: "Home", perms: [], source: "home", wide: true  },
  ...
  { id: "health-sentiment",        label: "Sentiment & Tone",    category: "Health", perms: ["admin"], source: "health", tileKey: "sentiment",        wide: false, nav: "health-sentiment",       needsNames: false },
