...
| Two Truths & a Lie | `/games play twotruths prompt:[str]` | Everyone | Statements shuffled at display time |
...
| Mt. Rushmore Draft | `/games play rushmore topic:[str] source:[host\|ai\|bank]` | Everyone | Snake draft, 4 rounds, no duplicates |
