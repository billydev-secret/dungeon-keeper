...
- **`/ask`** — An AI helper that answers "how do I use X" questions in plain language, grounded in the server guide (so it won't invent commands). Replies privately in Discord; also available as an "Ask the Guide" box on every dashboard Help page.
