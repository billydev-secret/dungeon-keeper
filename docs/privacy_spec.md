...
**Preserved on purpose**: [[dm-perms-spec]] consent and audit data, [[pressure-cooker-spec]] game history, [[starboard-spec]] quote audit, [[veil-spec]] / [[guess-spec]] / [[whisper-spec]] / [[jail-spec]] tables, [[reporting-spec]] invite tracker and raid records, and [[confessions-spec]] audit and submissions. The preserve list is implicit: a table is preserved iff it isn't named in the purge. New per-user tables landing in other features must make an explicit decision — either join the purge or document why they're kept.
