...
| [survivor_spec.md](survivor_spec.md) | Survivor: NFL pick'em survival pool — weekly straight-up picks, no team twice, per-game locks, one strike, the Gauntlet late-entry replay, Ghost Streak side-game, Tuesday Reckoning | **Not started** as of 2026-08-17 — spec v2.2 landed ahead of code, targeting NFL Week 1 (Sept 10 2026). Reclassify to Reference as stages ship; plan in [plans/survivor.md](plans/survivor.md) |
...
|---|---|---|
| [plans/survivor.md](plans/survivor.md) | Survivor staging plan: three tiers against the Sept 10 2026 NFL Week 1 deadline, cut lines if a stage slips, and the house obligations (data register, economy ledger kinds, guild-local scheduling) tracked per stage | Planned 2026-08-17, no stages built yet |
